...
* [tictactoe](https://examples.fritz2.dev/tictactoe/build/distributions/tictactoe.html) -  demonstrates the combination of UI, logic and state with fritz2's components and styling facilities
